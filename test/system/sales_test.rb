...
class SalesTest < ApplicationSystemTestCase
  ...
  test "should create sale" do
    ...
    fill_in "Buyer name", with: @sale.buyer_name
    fill_in "Clothing item", with: @sale.clothing_item_id
    fill_in "Delivery status", with: @sale.delivery_status
  ...
  test "should destroy Sale" do
    visit sale_url(@sale)
    accept_confirm { click_on "Destroy this sale", match: :first }
